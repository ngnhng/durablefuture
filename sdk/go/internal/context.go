...
func (c *workflowContext) ExecuteActivity(activityFn any, args ...any) Future {
	...
	// attributes, err := json.Marshal(api.ActivityTaskScheduledAttributes{
	...
	// newEvent := api.WorkflowEvent{
	// 	EventType:  api.ActivityScheduledEvent,
	// 	WorkflowID: string(c.ID()),
	// 	Attributes: attributes,
	// }
	// c.newEvents = append(c.newEvents, newEvent)
